<template>
  ...
  export default {
    ...
    mounted() {
      ...
      // Calculer la différence entre les deux tableaux
      const dataValues = this.khi2_theoriques;
      const dataValues2 = this.descriptors_khi2;
      const dataDiff = dataValues2.map((value, index) => value - dataValues[index]);
