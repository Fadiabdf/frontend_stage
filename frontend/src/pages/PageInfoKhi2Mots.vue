    ...
    <div>
        ...
        <div class="chart-section">
            ...
            <div class="chart-container">
                ...
                <Khi2 :selectedX="selectedX" :selectedY="selectedY" :mots_khi2="mots_khi2" />
            </div>
            <div class="chart-container">
                <h2 class="font-bold">Différence entre χ2 observé et χ2 theorique</h2>
                <chartMots :selectedX="selectedX" :selectedY="selectedY" :mots_khi2="mots_khi2" :khi2_theoriques="khi2_theoriques" />
            </div>
          ...
          Une valeur positive indique une dépendance entre les variables, tandis qu'une valeur négative suggère une indépendance.
            ...
            <div class="chart-container">
                ...
                <InfoMutuelle :selectedX="selectedX" :selectedY="selectedY" :mots="mots" />
            </div>
...
<script>
import Khi2 from '../components/Khi2_mots.vue';
import AppNavbar from '../components/AppNavbar.vue';
import InfoMutuelle from '../components/MI_mots.vue';
import chartMots from '../components/chartmots.vue'
