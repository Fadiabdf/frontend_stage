<template>
  <div class="hello">
    ...
    <div class="chart-container">
      <canvas id="infomutuelleAnn"></canvas>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    const dataValues = this.descriptors;

    const data = {
      labels: labels,
      datasets: [{
        label: 'Les valeurs de l\'information mutuelle',
        data: dataValues,
    ...
    const ctx = document.getElementById('infomutuelleAnn').getContext('2d');
